...
规则该落哪一层由三问定位（换角色还成立→全员区／角色专属→角色卡／subagent 需要→其系统提示词／产物格式→模板头部），判据表见 [`docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md#规则归属单一出处ssot分层--0131-立规)。
